...
// Weather-code mapping and clothing rules live in weather-logic.js,
// which is loaded before this file and exposes getWeatherConfig,
// isRainy, isSunny, clothingDatabase and getClothingRecommendations.
...
function renderClothingRecommendations(temp, code) {
    ...
    const matches = getClothingRecommendations(temp, code);
